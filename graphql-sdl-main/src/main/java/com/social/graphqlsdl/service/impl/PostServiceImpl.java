...
public class PostServiceImpl implements PostService {
    ...
    public UUID createPost(PostDto postDto) {
        final Optional<Author> author = authorRepository.findById(postDto.getAuthorId());
...
Post post =postRepository.saveAndFlush(build);
    ...
    public PostDto getPostById(UUID postId) {
        ...
        Post post= postOptional.orElseThrow(()->new ResourceNotFound("Post is not exist id:"+postId));
